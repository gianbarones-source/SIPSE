...
const COLS = {
  ...
  origen: 5, destino: 6, tipo: 7, precio: 8, detalle_servicios: 9,
  notas: 10, vendedor: 11, estado: 12, camion: 13, ayudantes: 14, timestamp: 15,
};
  ...
  try {
    ...
    let viajes = rows
      ...
      .map(r => ({
        ...
        detalle_servicios: r[COLS.detalle_servicios] || '',
        notas:             r[COLS.notas]             || '',
